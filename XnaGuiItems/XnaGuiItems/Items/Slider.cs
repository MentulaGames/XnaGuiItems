...
namespace Mentula.GuiItems.Items
{
     ...
     public class Slider : GuiItem
     {
          ...
          /// <summary>
          /// Initializes a new instance of the XnaMentula.GuiItems.Items.Slider class as a child.
          /// </summary>
          /// <param name="device"> The device to display the XnaMentula.GuiItems.Items.Slider to. </param>
          /// <param name="parent"> The XnaMentula.GuiItems.Core.GuiItem to be the parent of the slider. </param>
          public Slider(GraphicsDevice device, GuiItem parent)
               : base(device, parent)
          {
               InitEvents();
          ...
          /// <summary>
          /// Initializes a new instance of the XnaMentula.GuiItems.Items.Slider class as a child with a specified size.
          /// </summary>
          /// <param name="device"> The device to display the XnaMentula.GuiItems.Items.Slider to. </param>
          /// <param name="parent"> The XnaMentula.GuiItems.Core.GuiItem to be the parent of the slider. </param>
          /// <param name="bounds"> The size of the XnaMentula.GuiItems.Items.Slider. </param>
          public Slider(GraphicsDevice device, GuiItem parent, Rectangle bounds)
          ...
          /// <summary>
          /// Updates the XnaMentula.GuiItems.Items.Slider and its childs, checking if any mouse event are occuring.
          /// </summary>
          ...
          /// <summary>
          /// Draws the XnaMentula.GuiItems.Items.Slider and its childs to the specified spritebatch.
          /// </summary>
